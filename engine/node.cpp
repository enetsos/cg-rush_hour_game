...
int Node::getNumberOfChildren() const { return (int)this->children.size(); }
...
Node LIB_API *Node::getParent() const { return parent; }

glm::mat4 LIB_API Node::getTransform() const { return transform; }
